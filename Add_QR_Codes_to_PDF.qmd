...
[![Build Status](https://github.com/chrissyhroberts/QR_adder/actions/workflows/build.yml/badge.svg)](https://github.com/chrissyhroberts/QR_adder/actions) [![Python Version](https://img.shields.io/badge/python-3.11%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
...
![](images/clipboard-2432796165.png){width="321"}
...
Download the latest release from the [Releases](https://github.com/chrissyhroberts/QR_adder/releases) page.
